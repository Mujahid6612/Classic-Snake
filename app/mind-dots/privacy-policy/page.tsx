...
export const metadata: Metadata = {
  title: "Privacy Policy — Mind Dots",
  description:
    "Privacy policy for the Mind Dots mobile puzzle game, covering local data storage and advertising via Google AdMob.",
};
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
        <div className="px-6 py-8">
          ...
          <p className="text-center text-gray-500 mb-8">
            Mind Dots · Last updated: {LAST_UPDATED}
          </p>

          <div className="space-y-6 text-gray-600">
            <section>
              <p className="mb-4">
                This Privacy Policy describes how Mind Dots (&quot;the
                app&quot;, &quot;we&quot;, &quot;us&quot;) handles information
                when you use our mobile puzzle game on Android. Mind Dots is a
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                servers. Your game progress, level completion, coins and
                settings (such as sound and background preferences) are stored
                only locally on your device and never leave it.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                permanently deletes your progress, coins, and settings. We
            ...
            <section>
              ...
              <p className="mb-4">
                Mind Dots is not directed at children under 13, and the app is
                intended for users aged 13 and older. We do not knowingly
                collect personal information from children under 13. If you
                believe a child under 13 has provided personal information
                through the app, contact us at {CONTACT_EMAIL} and we will take
        ...
        <div className="border-t border-gray-200 px-6 py-4">
          <p className="text-sm text-gray-500 text-center">
            © {new Date().getFullYear()} Mind Dots. All rights reserved.
          </p>
        </div>
      </div>
    </div>
